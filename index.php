  ...
  -->
              ...
              <li>
                ...
                <ul class="dropdown">
                  ...
                  <li><a href="buttons.html">Semi-Autonomous bots</a>
                  </li>
                ...
                -->
																					...
																					<li>
																						...
																						<ul class="dropdown">
																							...
																							<li><a href="tabs.html">ROBOCITY'19</a>
																							</li>
																							<li><a href="portfolio-4.html">AAROHAN'19</a>
																							</li>
																					...
																					<img class="img-responsive" src="images/Slider.jpg">																				
																						...
																						<div class="slider-content">
																							<div class="col-md-12 text-center">
																								...
																								<p class="animated4"><a href="#float" class="slider btn btn-system btn-large">CHECKOUT EVENTS</a>
																								</p>
																							</div>
																						</div>
																					</div>
																					...
																					<div class="item">
																						<img class="img-responsive" src="images/slider-2.jpg">
																							<div class="slider-content">
																								<div class="col-md-12 text-center">
																									<h2 class="animated4">
																										<span>We At <strong>NIT DURGAPUR</strong> <br><br> Provide Students A Chance </span>
																											</h2>
																											<h3 class="animated4">
																												<span><strong>To Design And Deliver Robots</strong></span>
																											</h3>
																											<p class="animated6"><a href="#float" class="slider btn btn-system btn-large">CHECKOUT WORKSHOPS</a>
																											</p>
																										</div>
																									</div>
																								</div>
																								<!--/ Carousel item end -->
																								<div class="item">
																									<img class="img-responsive" src="images/slider-3.jpg">
																										<div class="slider-content">
																											<div class="col-md-12 text-center">
																												<h2 class="animated7 white">
																													<span>Here You Can Learn Concepts Of <br> <br><strong>Robotics </strong></span>
																														...
																														<h3 class="animated8 white">
																															<span>NO Prior Experience Required, <strong>Enthusiasm </strong>Is All We Need</span>
																														</h3>
																														<div class="">
																															<a class="animated4 slider btn btn-default btn-min-block" href="#float
																															">LEARN TO MAKE BOTS</a>
																														</div>
																													</div>
																												</div>
																											</div>
																								...
																								<div class="section service">
																									<div class="container">
																										...
																										<div  class="big-title text-center" >
																											...
																											<p>We are a soceity of engineers based in NIT Durgapur who promote and deal with the science of robots in our college.
																												We organize several robotic competitions, events and workshops throughout the year.
																												Robo Cell also works on automation and smart system projects and promotes them.</p>

																										</div>
																										<div  class="big-title text-center" >
																											<h1><strong>Vision Of Our Cell</strong></h1>
																											<p>The RoboCell has a single goal: to popularize and spread awareness about Robotics.
																										...
																										<div class="row">
																											...
																											<div class="col-md-3 col-sm-6 service-box service-center col-lg-offset-3" data-animation="fadeIn" data-animation-delay="01">
																												...
																												<div class="service-content" id="float">
																													<h4><a href="#">EVENTS</a></h4>
																													<p>RoboCity, Armageddon, Robo Wars. You say it, we've got it!</p>
																												</div>
																											</div>
																											<!-- End Service Icon 3 -->
																											...
																											<div class="col-md-3 col-sm-6 service-box service-center" data-animation="fadeIn" data-animation-delay="01">
																												...
																												<div class="service-content" id="float">
																													...
																													<p>Wanna learn something new? Wanna build something to make your friends jealous? Check out our tutorials to do just that!</p>
																												</div>
																											</div>
																											<!-- End Service Icon 4 -->
																											...
																											<div class="col-md-3 col-sm-6 service-box service-center col-lg-3 col-lg-offset-3" data-animation="fadeIn" data-animation-delay="02">
																												...
																												<div class="service-content" id="float">
																													...
																													<p>Manual, Semi-Autonomous or Autonomous, we build everything. Check out our Workshops to participate and get hands-on learning experience.</p>
																												</div>
																											</div>
																											<!-- End Service Icon 7 -->
																											...
																											<div class="col-md-3 col-sm-6 service-box service-center" data-animation="fadeIn" data-animation-delay="02">
																												...
																												<div class="service-content">
																													...
																													<p>Need our Help? Click on to get our expert suggestions.</p>
																												</div>
																											</div>
																											<!-- End Service Icon 8 -->
                       ...
                       bots with us <br/>participate in our workhops <strong>as well as</strong> events
																								...
																								<div class="section full-width-portfolio" style="border-top:0; border-bottom:0; background:#fff;">
																									...
																									<div class="big-title text-center" data-animation="fadeInDown" data-animation-delay="01">
																										<h1>EVENTS IN <strong>2018-19 SESSION</strong></h1>
																									</div>
																									<!-- End Big Heading -->

																									<p class="text-center">This year is full of exciting events organized by our RoboCell. Like the previous years, there will be a selection of fun-filled events. Only that in the current session, they will be more competitive and up to date with our time.
																										<br/>Do join us to participate, compete and win loads of goodies!</p>
																									...
																									<ul id="portfolio-list" data-animated="fadeIn">
																										...
																										<li>
																											...
																											<div class="portfolio-item-content">
																												...
																												<p class="body">September 2018</p>
																											</div>
																											<a href="tabs.html"><i class="more">GO</i></a>
																													...
																													<div class="latest-posts-classic custom-carousel touch-carousel" data-appeared-items="2">
																														...
																														<div class="post-row item">
																															...
																															<div class="post-content">
																																<p>This workshop aims to build a semi-autonomous bot that can be controlled remotely but also uses a variety of sensors. <a class="read-more" href="#">Read More...</a></p>
																															</div>
																														</div>
																									...
																									<div class="container">
																										<div class="row">
																											...
																											<div class="big-title text-center">
																												...
																												<p class="title-desc">Who make us LARGE</p>
																											</div>
																											<!-- End Big Heading -->
